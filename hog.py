...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    def swine_swap(score, opponent_score):
        ...
        if opponent_score == score * 2 or score == opponent_score * 2:
            return True
        return False
    ...
    while score < goal and opponent_score < goal:
        ...
        if who == 0:
            ...
            if swine_swap(score, opponent_score) == True:
...
def swap_strategy(score, opponent_score):
    ...
    5
    """
    if ((opponent_score > score) and (opponent_score == score * 2 or score == opponent_score * 2)) or bacon_strategy(score, opponent_score) == 0:
        return 0
